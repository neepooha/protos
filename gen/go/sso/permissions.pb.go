...
type DelAdminResponse struct {
	...
	DelAdmin string `protobuf:"bytes,1,opt,name=del_admin,json=delAdmin,proto3" json:"del_admin,omitempty"`
}
...
func (x *DelAdminResponse) GetDelAdmin() string {
	if x != nil {
		return x.DelAdmin
	}
	return ""
...
var file_sso_permissions_proto_rawDesc = []byte{
	...
	0x6e, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x64, 0x65, 0x6c, 0x41, 0x64, 0x6d, 0x69,
	0x6e, 0x32, 0x83, 0x01, 0x0a, 0x0b, 0x50, 0x65, 0x72, 0x6d, 0x69, 0x73, 0x73, 0x69, 0x6f, 0x6e,
	...
	0x6f, 0x68, 0x61, 0x2e, 0x73, 0x73, 0x6f, 0x2e, 0x76, 0x31, 0x3b, 0x73, 0x73, 0x6f, 0x76, 0x31,
...
var file_sso_permissions_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
...
var file_sso_permissions_proto_depIdxs = []int32{
	...
	1, // 2: perm.Permissions.SetAdmin:output_type -> perm.SetAdminResponse
	3, // 3: perm.Permissions.DelAdmin:output_type -> perm.DelAdminResponse
